 ...
 * Signature: (J)J
 */
JNIEXPORT jlong JNICALL Java_org_linphone_core_LinphoneCallImpl_getChatRoom
  (JNIEnv *, jobject, jlong);
 ...
 * Signature: (JJ)J
 */
JNIEXPORT jlong JNICALL Java_org_linphone_core_LinphoneCoreImpl_getChatRoom
  (JNIEnv *, jobject, jlong, jlong);
