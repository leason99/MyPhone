...
public class ContactsListFragment extends Fragment implements OnClickListener, OnItemClickListener,AdapterView.OnItemLongClickListener {
	private LayoutInflater mInflater;
	private ListView contactsList;
	private TextView noSipContact, noContact;
	private ImageView  selectAll, deselectAll, delete, cancel;
	//private ImageView edit, linphoneContacts, newContact, allContacts;
	private boolean onlyDisplayLinphoneContacts=true, isEditMode;
	private RelativeLayout   editList, topbar;
//	private RelativeLayout linphoneContactsSelected,allContactsSelected;
...
/*
	...
	private void removeContacts(int position){
				Contact contact = (Contact) contactsList.getAdapter().getItem(position);
				deleteExistingContact(contact);
				ContactsManager.getInstance().removeContactFromLists(getActivity().getContentResolver(), contact);
	}
