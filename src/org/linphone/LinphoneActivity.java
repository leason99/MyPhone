...
public ViewPager getViewPager(){
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   else if (useFirstLoginActivity && LinphonePreferences.instance().isFirstLaunch()) {
        ...
        setContentView(R.layout.my_phone_main);
        instance = this;
...
*/
    ...
    if (newFragmentType == currentFragment && newFragmentType != FragmentsAvailable.CHAT&& newFragmentType!= FragmentsAvailable.CONTACT_DETAIL) {
        ...
        switch (newFragmentType) {
            ...
            case CONTACT_DETAIL:
                ...
                DialogFragment buf = new ContactDetailsFragment();
                buf.setArguments(extras);
                buf.show(ft, "dialog");
                break;
            case CONTACT_EDITOR:
            ...
            case ACCOUNT_SETTINGS:
                ...
                intent.putExtras(extras);
                intent.setClass(this, MyAccountPreferenceActivity.class);
                startActivity(intent);
    ...
    public void displayAssistant() {
        startActivity(new Intent(LinphoneActivity.this, MyLogin.class));
    }
    ...
    private void resetSelection() {
        ...
        myInfo_selectes.setVisibility(View.GONE);
    }
