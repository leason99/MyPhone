...
/**
 * Created by leason on 2016/3/23.
 */
public class ChatActivity extends Activity implements View.OnClickListener, LinphoneChatMessage.LinphoneChatMessageListener {
...
//        final View view = inflater.inflate(R.layout.chat, container, false);
    ...
    //   setRetainInstance(true);
        ...
        if(/*getArguments() == null ||*/  bundle.getString("SipUri") == null) {
        ...
        messagesList = (ListView) findViewById(R.id.chat_message_list);
        searchContactField = (AutoCompleteTextView) findViewById(R.id.search_contact_field);

        editList = (RelativeLayout) findViewById(R.id.edit_list);
        textLayout = (LinearLayout) findViewById(R.id.message_layout);
        topBar = (RelativeLayout) findViewById(R.id.top_bar);

        sendMessage = (ImageView) findViewById(R.id.send_message);
        sendMessage.setOnClickListener(this);

        remoteComposing = (TextView) findViewById(R.id.remote_composing);
        ...
        startCall = (ImageView) findViewById(R.id.start_call);
        startCall.setOnClickListener(this);

        backToCall = (ImageView) findViewById(R.id.back_to_call);
        backToCall.setOnClickListener(this);

        selectAll = (ImageView) findViewById(R.id.select_all);
        selectAll.setOnClickListener(this);

        deselectAll = (ImageView) findViewById(R.id.deselect_all);
        ...
        if (newChatConversation) {
           ...
           // searchContactField.setAdapter(new SearchContactsListAdapter(inflater));
            searchContactField.setAdapter(new SearchContactsListAdapter());
        ...
        sendImage = (ImageView)findViewById(R.id.send_picture);
    ...
    public void dispayMessageList() {
        ...
        adapter = new ChatMessageAdapter(/*getActivity()*/this, chatRoom.getHistory());
    ...
    public void onPause() {
        ...
        onSaveInstanceState(/*getArguments()*/bundle);
...
*/
        ...
        String draft = bundle.getString("messageDraft");
    ...
    private void sendImageMessage(String path, int imageSize) {
        ...
        if (chatRoom != null && path != null && path.length() > 0 && isNetworkReachable) {
            try {
                ...
                if (bm != null) {
                    FileUploadPrepareTask task = new FileUploadPrepareTask(/*getActivity()*/this, path, imageSize);
                    task.execute(bm);
                } else {
    ...
    private void copyTextMessageToClipboard(int id) {
        ...
        if (msg != null) {
            Compatibility.copyTextToClipboard(/*getActivity()*/this, msg);
    ...
    public String getRealPathFromURI(Uri contentUri) {
        ...
        CursorLoader loader = new CursorLoader(/*getActivity()*/this, contentUri, proj, null, null, null);
    ...
    class SearchContactsListAdapter extends BaseAdapter implements Filterable {
        ...
        public List<ContactAddress>getContactsList(){
            ...
            for(Contact con: ContactsManager.getInstance().getSIPContacts()){
